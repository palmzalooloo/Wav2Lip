...
parser.add_argument('--model_name', help='Model name for wandb.ai', default="syncnet", type=str)
...
if __name__ == "__main__":
    ...
    # init wandb
    wandb.init(project="my-test-project", entity="looloo", name=args.model_name)
    wandb.config = {
